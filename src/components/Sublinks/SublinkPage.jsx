      ...
      x.id===id &&
        <div key={id} className='font-customFont mt-[65px] w-full h-full'>
          <div className=' relative h-[300px] z-1'>
            <img className='object-cover h-full w-full blur-[2px] brightness-50 shadow-2xl' src={window.location.origin + `/images/${x.title}-Wallpaper.jpg`} alt="engineering" />
          ...
          <img className='object-cover w-3/4 max-h-[400px] mt-16 laptop:w-1/2 laptop:px-6' src={window.location.origin + `/images/${x.title}.jpg`} alt='engineering' />
